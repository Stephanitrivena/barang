		 ...
		 <!-- Bagian Pembuka Isi Conten Template -->
          ...
          <div class="row">
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Grafik Perbandingan Jumlah Produk</h6>
                </div>
                <div class="card-body">
...
<script>
  ...
  var BarChart = new Chart(ctx,{
    ...
    data:{
      labels: lbls, //nilai y
      datasets:[{
        label:"Jumlah Perbandingan Stok",
        backgroundColor: "rgba(2,117,216,1)",
        borderColor: "rgba(2,117,216,1)",
        data:produks, //nilai x
      }],
    },
    option:{
      scales:{
        xAxes: [{ //Pengaturan nilai x
          time: {
            unit: 'Product'
          },
          gridLines:{
